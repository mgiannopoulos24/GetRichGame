...
export const Landing: React.FC = () => {
    const logoColor = 'text-indigo-400';
    const adventureColor = 'text-indigo-300';
                ...
                <section className="py-24 md:py-36 bg-gray-900">
                    <div className="max-w-2xl mx-auto text-center px-4">                    
                        ...
                        <p className="text-lg md:text-xl text-gray-400 mb-12 max-w-xl mx-auto">
                            Join millions of players in the ultimate strategy game experience, powered by a high-performance Python backend.
                        </p>
                        ...
                        <div className="flex flex-col md:flex-row justify-center gap-3">
                            ...
                            <Button 
                                ...
                                size="lg" 
                                className="text-base"
                                onClick={() => console.log("Connecting to a Quick Match...")}
                            >
                    ...
                    <div className="max-w-4xl mx-auto px-4">
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {rules.map((rule, index) => (
                                <div key={index} className="bg-gray-700 p-6 rounded-xl shadow-md hover:shadow-lg transition duration-300">
                                    <p className={`font-bold text-lg mb-2 ${adventureColor}`}>Rule {index + 1}</p>
            ...
            <footer className="mt-auto border-t border-gray-700 bg-gray-950 text-white p-6 md:p-10">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center text-center md:text-left">
                    <div className="mb-4 md:mb-0">
                        <p className="text-lg font-semibold">&copy; {new Date().getFullYear()} GetRich</p>
                    </div>
                    ...
                    <div className="flex items-center space-x-6">
                        <a 
                            ...
                            className="text-gray-400 hover:text-indigo-400 transition duration-300 flex items-center"
                        >
